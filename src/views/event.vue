                  ...
                  <base-table :list="eventList" tableHeight="480px">
                    <el-table-column width="500px" prop="title" label="标题和内容">
                      <template slot-scope="scope">
                        ...
                        <div v-else>
                          <span
                            v-html="highLight(limitTextLength(scope.row.title, 480), reqParams.keywords)"
                          ></span>
                          <span
                            class="full-information"
                            @click.stop="handleExpandchange(1, scope.$index)"
                    ...
                    <el-table-column width="200px" prop="publisher" label="发布者">
                      <template slot-scope="scope">
                        ...
                        <div v-else>
                          <span>{{limitTextLength(scope.row.publisher, 180)}}</span>
                          <span
                            class="full-information"
                            @click.stop="handleExpandchange(3, scope.$index)"
                            v-if="textTooLong(scope.row.publisher, 180)"
                          >&nbsp;展开&nbsp;&gt;</span>
                        </div>
                      </template>
                    </el-table-column>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      resultData: state => state.event.resultData
    }),
    totalCount () {
  ...
  methods: {
    ...mapActions({ getRemoteData: 'event/getRemoteData' }),
    formatDate,
    highLight,
    limitTextLength,
    textTooLong,
